...
/**
 * A wrapper for PreparedStatement only to close the statement and connection if needed =/
 */
public class PreparedStatementWrapper implements PreparedStatement {
    private final PreparedStatement stmt;
    private final boolean closeConnection;

    public PreparedStatementWrapper(PreparedStatement stmt, boolean closeConnection) {
        this.stmt = stmt;
    ...
    public void close() throws SQLException {
        try {
            ...
            if (closeConnection) stmt.getConnection().close();
        }
    }
